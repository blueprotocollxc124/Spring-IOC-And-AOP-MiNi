...
import com.mini.aop.JdkInvocationHandler;
...
public class DispatcherServlet extends HttpServlet {
	  ...
	  protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
			JdkInvocationHandler jdkInvocationHandler = (JdkInvocationHandler)BeanFactory.getBean("jdkInvocationHandler");
			MyService proxy = (MyService) jdkInvocationHandler.getProxy();
			System.out.println("Count="+proxy.getCount());
	  }
